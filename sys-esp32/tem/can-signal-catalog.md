...
- **Bus:** low | **DLC:** 8 | **Sender:** SES | **Cycle:** 10ms
- **Receivers:** RT
...
- **Bus:** low | **DLC:** 8 | **Sender:** SES | **Cycle:** 100ms
- **Receivers:** RT
...
- **Bus:** low | **DLC:** 8 | **Sender:** SES | **Cycle:** 1000ms
- **Receivers:** RT
...
- **Receivers:** SYS, MTR
- **Comment:** MTR receives for motor actuation. SYS receives for EGAS L2 monitoring. ID 0x204 avoids collision with SES 0x202.
