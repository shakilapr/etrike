...
void test_sys_bypass_modes(void) {
    ...
    // 2. Hardware Prototype without Jumper (run_mode = 1, pin HIGH) -> Safety Enforced
    ...
    // 3. Hardware Prototype WITH Jumper (run_mode = 1, pin LOW) -> Bypasses Active
    ...
    //    (override pin state is irrelevant in mode 2)
    ...
    // 4b. Bench Simulation Mode regardless of jumper state
