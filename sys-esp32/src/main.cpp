...
[[noreturn]] static void task_dispatch(void*) {
    ...
    while (1) {
        ...
        case can::kIdSES/SEBSebStatus: {  // 0x721
        ...
        case can::kIdSES/SEBSebTest: {     // 0x6FB — SEB_Test telemetry (arch §8.3)
        ...
        case can::kIdSES/SEBSebErrInfo: {  // 0x731 — SEB_ErrInfo (arch §8.3)
        ...
        case can::kIdSES/SEBSebVersion: {  // 0x741 — SEB_Version (arch §8.3)
