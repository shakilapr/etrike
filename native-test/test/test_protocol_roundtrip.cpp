 ...
 *   - SES/SEB LE pack/unpack roundtrips
 */
...
/* ===================================================================
 *  14) VcuSesReq (0x169)  -- SES/SEB LE pack/unpack + checksum
 * =================================================================== */
...
static void test_vcu_ses_req() {
    ...
    {
        can::VcuSesReq r{};
        r.target_speed = 328;   // SES/SEB default
...
/* ===================================================================
 *  15) VcuSebReq (0x7B9)  -- SES/SEB LE pack/unpack + checksum
 * =================================================================== */
...
int main() {
    ...
    printf("\n--- SES/SEB protocol (little-endian) ---\n");
    test_vcu_ses_req();
    test_vcu_seb_req();
