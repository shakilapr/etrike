import { ID_SAFETY_ESTOP, ID_HOST_DRIVE_CMD, ID_HOST_BRAKE_REQ, ID_SYS_MODE_CMD, ID_RT_DRIVE_CMD, ID_RT_BRAKE_CMD, ID_VCU_SES_REQ, ID_RT_STATE_RPT, ID_RT_HEARTBEAT } from "@etrike/debug-shared";
/**
