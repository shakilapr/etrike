...
export const CAN_MESSAGES: CanMessageDef[] = [
  ...
  msg("low", "0x201", "SES_STATUS", "SES", "100 Hz", 8, true, [bool("angle_status", "Angle status"), num("str_angle", "Steer angle", "0.1 deg"), num("tgt_angle_spd", "Target angle speed", "deg/s"), num("error_status", "Error status", undefined, 0, 3)]),
  msg("low", "0x202", "SES_ERRINFO", "SES", "10 Hz", 8, false, [num("fault_mask", "Fault mask")]),
...
export const INJECTION_TEMPLATES: InjectionTemplate[] = [
  ...
  { bus: "low", id: "0x169", name: "Steer center", description: "SES steering command.", dlc: 8, values: { target_angle: 0, target_speed: 328, control_enable: true, rolling_counter: 1, checksum: 0 } },
