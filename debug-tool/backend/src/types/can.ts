...
export const CAN_MESSAGES: CanMessageDef[] = [
  ...
  msg("low", "0x201", "SES_STATUS", "SES", "100 Hz", 8, true, [bool("angle_status", "Angle status"), num("control_mode_sts", "Control mode status", undefined, 0, 3), num("str_angle", "Steer angle", "0.1 deg"), num("tgt_angle_spd", "Target angle speed", "deg/s"), num("error_status", "Error status", undefined, 0, 3), num("rolling_counter", "Rolling counter", undefined, 0, 15), num("checksum", "Checksum", undefined, 0, 255)]),
  msg("low", "0x202", "SES_ERRINFO", "SES", "10 Hz", 8, true, [num("fault_mask", "Fault mask")]),
  msg("low", "0x203", "SES_VERSION", "SES", "1 Hz", 8, false, [num("sw_version", "SW version"), num("hw_version", "HW version")]),
  ...
  msg("low", "0x6FA", "SES_TEST", "SES", "100 Hz", 8, false, [num("motor_current", "Motor current"), num("ecu_temp", "ECU temp"), num("supply_voltage", "Supply voltage")]),
...
export const INJECTION_TEMPLATES: InjectionTemplate[] = [
  ...
  { bus: "low", id: "0x169", name: "RT steer center", description: "RT to SES steering command.", dlc: 8, values: { target_angle: 0, target_speed: 328, control_enable: true, rolling_counter: 1, checksum: 0 } },
  ...
  { bus: "low", id: "0x201", name: "SES status (bypass)", description: "Synthetic SES status: 0° centered, aligned. Inject every 100ms.", dlc: 8, values: { angle_status: true, str_angle: 0, tgt_angle_spd: 0, error_status: 0, rolling_counter: 1, checksum: 0 } },
