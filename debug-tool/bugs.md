...
### BUG-59: SES / SES Steering Angle Snap-to-Death
...
### BUG-60: "SES" vs "SES" Naming Schism across Architecture
...
- **BUG-55:** `Dashboard.svelte` hardcodes the obsolete `"SES"` string for steering instead of the updated `"SES"`.
