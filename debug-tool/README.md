...
└─────────┼────────────────────────────────────────────────────────────┘
   ...
   High-Level CAN Bus (500 kbit/s)
          │
    ┌─────┴─────┐  ┌──────────┐
    │  Jetson   │  │ RT ESP32 │──(low bus)── SYS, MTR, SES/SEB...
    └───────────┘  └──────────┘
...
Actuator-level frames (SES/SEB 0x169/0x7B9, MTR 0x206, etc.) stay on the low bus and can be added as a v2 feature with a second TWAI or MCP2515.
