...
CAN bus monitor, analyzer, and command injector for the E-Trike vehicle control system. Connects to both CAN buses via an ESP32-S3 bridge over MQTT. Streams decoded frames to a web UI, and can inject commands to simulate any node — Jetson, RT, SYS, MTR, or SES/SEB actuators.
