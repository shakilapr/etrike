...
describe("decodeFrame", () => {
  ...
  it("decodes 0x169 VCU_SES_REQ (SES/SEB LE)", () => {
...
describe("round-trip encode→decode", () => {
  ...
  // SES/SEB messages have rolling_counter and checksum that aren't perfectly round-tripped
  it("round-trip: low:0x169 (SES/SEB steering)", () => {
  ...
  it("round-trip: low:0x7B9 (SES/SEB brake)", () => {
