...
export const CAN_INDEX: CanMessageIndex[] = [
  ...
  {bus:"high", id:"0x310", name:"STEER_DIAG", dlc:8, sender:"RT", receivers:["Host"], cycle_ms:100, comment:"Steering telemetry to Host. v0.0.4 \u00e2\u20ac\u201d previously missing from DBC.", signals:[
    ...
    {"SteerDiag_Fault", byte:2, bit_offset:0, size:8, type:"unsigned", factor:1, offset:0, unit:"", min:0, max:1, values:null, comment:"0=OK, 1=SES fault"},
    {"SteerDiag_MotorCurrent", byte:3, bit_offset:0, size:16, type:"unsigned", factor:0.01, offset:0, unit:"A", min:0, max:0, values:null, comment:"SES motor current, 0.01A/bit"},
    {"SteerDiag_ECUTemp", byte:5, bit_offset:0, size:16, type:"unsigned", factor:0.1, offset:0, unit:"degC", min:0, max:0, values:null, comment:"SES ECU temperature, 0.1degC/bit"},
  ...
  {bus:"low", id:"0x169", name:"VCU_SES_REQ", dlc:8, sender:"RT", receivers:["SES"], cycle_ms:20, comment:"steer-by-wire unit command. 50 Hz continuous. Byte 5 overlap: Speed[15:8] shares with security nibble per CSV.", signals:[
  ...
  {bus:"low", id:"0x201", name:"SES_STATUS", dlc:8, sender:"SES", receivers:["RT"], cycle_ms:10, comment:"steer-by-wire unit status feedback. 100 Hz. Byte 5 overlap: StrAngleSpd[15:8] / Torq share byte 5 per CSV.", signals:[
  ...
  {bus:"low", id:"0x202", name:"SES_ErrInfo", dlc:8, sender:"SES", receivers:["RT"], cycle_ms:100, comment:"steer-by-wire unit detailed fault flags. 8 L3 faults (redundant sensor loss) -> RT must escalate to ESTOP.", signals:[
  ...
  {bus:"low", id:"0x203", name:"SES_Version", dlc:8, sender:"SES", receivers:["RT"], cycle_ms:1000, comment:"steer-by-wire unit firmware version. Log on boot for compatibility check.", signals:[
  ...
  {bus:"low", id:"0x204", name:"RT_DRIVE_CMD", dlc:5, sender:"RT", receivers:["SYS", "MTR"], cycle_ms:10, comment:"MTR receives for motor actuation. SYS receives for EGAS L2 monitoring. ID 0x204 avoids collision with SES 0x202.", signals:[
  ...
  {bus:"low", id:"0x6FA", name:"SES_Test", dlc:8, sender:"SES", receivers:["RT"], cycle_ms:10, comment:"steer-by-wire unit telemetry. 100 Hz. Bytes 0,7 reserved. Narrower ranges than brake SEB_Test.", signals:[
