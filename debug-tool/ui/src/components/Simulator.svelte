<script lang="ts">
  ...
  const SIGNALS: SimSignal[] = [
    ...
    // ── Steering (SES) ──
    {
      key: "ses_status", section: "Steering (SES)", label: "SES Status",
      bus: "low", id: "0x201", hz: 100, dlc: 8,
      data: [0x01, 0, 0, 0, 0, 0, 0x10, 0xFF],
      description: "Angle OK, 0°, rolling ctr=1"
    },
    {
      key: "ses_errinfo", section: "Steering (SES)", label: "SES Error Info",
      bus: "low", id: "0x202", hz: 10, dlc: 8,
      data: [0, 0, 0, 0, 0, 0, 0, 0],
      description: "No faults (all-zero fault mask)"
    },
    {
      key: "ses_version", section: "Steering (SES)", label: "SES Version",
