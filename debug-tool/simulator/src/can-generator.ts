...
export const DEFAULT_PROFILE: Profile = [
  // ── High bus (Jetson ↔ RT) ──
  { bus: "high", id: "0x001", name: "ESTOP_CMD", interval_ms: 100, dlc: 8 },
  { bus: "high", id: "0x011", name: "SYS_SAFETY_STS", interval_ms: 100, dlc: 8 },
  { bus: "high", id: "0x120", name: "HOST_SPEED_OPS", interval_ms: 100, dlc: 8 },
  { bus: "high", id: "0x206", name: "MTR_MOTOR_FBK", interval_ms: 50, dlc: 8 },
  { bus: "high", id: "0x210", name: "RT_STATE", interval_ms: 100, dlc: 8 },
  { bus: "high", id: "0x220", name: "RT_LED_STATUS", interval_ms: 200, dlc: 6 },
  { bus: "high", id: "0x300", name: "HOST_DRIVE_CMD", interval_ms: 100, dlc: 8 },
  { bus: "high", id: "0x301", name: "RT_BRAKE_PRES_CMD", interval_ms: 100, dlc: 8 },
  { bus: "high", id: "0x302", name: "RT_BRAKE_PRES_FBK", interval_ms: 100, dlc: 8 },
  { bus: "high", id: "0x400", name: "OBSTACLE", interval_ms: 100, dlc: 5 },
  { bus: "high", id: "0x600", name: "DIAGNOSTIC", interval_ms: 1000, dlc: 8 },
  { bus: "high", id: "0x7FC", name: "JETSON_HEARTBEAT", interval_ms: 500, dlc: 5 },
  ...
  { bus: "low", id: "0x202", name: "SES_SENSOR_STATUS", interval_ms: 100, dlc: 4 },
  { bus: "low", id: "0x203", name: "SES_RES_CMD", interval_ms: 200, dlc: 8 },
  { bus: "low", id: "0x204", name: "RT_DRIVE_CMD", interval_ms: 50, dlc: 8 },
  { bus: "low", id: "0x205", name: "RT_BRAKE_TARGET", interval_ms: 100, dlc: 8 },
  { bus: "low", id: "0x206", name: "VDDP_STATUS", interval_ms: 100, dlc: 6 },
  { bus: "low", id: "0x302", name: "RT_BRAKE_PRES_FBK", interval_ms: 100, dlc: 8 },
  ...
  { bus: "low", id: "0x731", name: "SEB_DIAG", interval_ms: 1000, dlc: 6 },
