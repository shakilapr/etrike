...
describe("0x169 VCU_SES_REQ encoding (SES/SEB)", () => {
  it("DLC=8, 50 Hz, low bus, valid SES/SEB checksum", () => {
    const runner = new SimulationRunner();
    runner.configure(cfg({
      hostDriveCycle: [{ durationMs: 99999, speedMmps: 500, yawRateMradS: 100, gear: 1 }],
    }));
...
describe("0x201 SES_STATUS encoding (SES/SEB)", () => {
...
describe("0x202 SES_ErrInfo encoding (SES/SEB)", () => {
...
describe("0x203 SES_Version encoding (SES/SEB)", () => {
...
describe("0x6FA SES_Test encoding (SES/SEB)", () => {
...
describe("0x7B9 VCU_SEB_REQ encoding (SES/SEB)", () => {
...
describe("0x721 SEB_STATUS encoding (SES/SEB)", () => {
...
describe("0x731 SEB_ErrInfo encoding (SES/SEB)", () => {
  it("DLC=8, 10 Hz, fault bits populated", () => {
    const runner = new SimulationRunner();
    runner.configure(cfg({
      hostDriveCycle: [{ durationMs: 99999, speedMmps: 500, yawRateMradS: 0, gear: 1 }],
...
describe("0x741 SEB_Version encoding (SES/SEB)", () => {
  it("DLC=8, 1 Hz", () => {
    const runner = new SimulationRunner();
    runner.configure(cfg({
      hostDriveCycle: [{ durationMs: 99999, speedMmps: 500, yawRateMradS: 0, gear: 1 }],
...
describe("0x6FB SEB_Test encoding (SES/SEB)", () => {
  it("DLC=8, 100 Hz, telemetry populated (non-zero)", () => {
    const runner = new SimulationRunner();
    runner.configure(cfg({
      hostDriveCycle: [{ durationMs: 99999, speedMmps: 500, yawRateMradS: 0, gear: 1 }],
