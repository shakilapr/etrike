...
// ═══════════════════════════════════════════════════════════
//  0x169 VCU_SES_REQ — SES/SEB LE encoding + checksum
// ═══════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════
//  0x7B9 VCU_SEB_REQ — SES/SEB LE encoding (BROKEN BEFORE — verified fixed)
// ═══════════════════════════════════════════════════════════
...
describe("0x6FA SES_Test — telemetry populated", () => {
  it("has non-zero ECU temp and voltage (was stub zeros before fix)", () => {
    ...
    expect(f).toBeDefined();
    expect(f!.dlc).toBe(8);
    // SES/SEB layout: byte0=reserved, bytes1-2=motor_current, bytes3-4=ecu_temp, bytes5-6=voltage
