...
describe("RT to low-bus pipeline", () => {
  ...
  it("RT forwards low-bus category 1 messages to high", () => {
    // 0x011 SYS_SAFETY_STS should be forwarded low→high (DLC=5)
    const safetyFrame = makeFrame("0x011", "low", [0, 1, 0, 0, 0]);
  ...
  it("SES produces 0x201 after receiving 0x169", () => {
    const cmd169 = {
