/**
 * SES/SEBSeb — simulated SES/SEB SEB brake actuator.
 *
...
export class SES/SEBSeb implements SimulatedEcu {
  readonly id = "SES/SEB SEB";
  ...
  tick(
    ...
    if (nowMs - this.lastCmdMs > 20 && timeSinceStartup > SES/SEBSeb.SEB_STARTUP_GRACE_MS) {
      this.errorStatus = 3;
    } else {
      this.errorStatus = 0;
    }
