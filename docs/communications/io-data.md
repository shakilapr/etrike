...
| `0x169` | VCU_SES_REQ | `VCU_SES_Tgt_StrAngleSpd` | u16 (?/s) | ? | 50 Hz | SES |
...
| MTR ? SYS (0x206) | Command-path consistency (EGAS L2 role): SYS compares 0x204 cmd vs 0x206 applied speed command (setpoint echo) |
