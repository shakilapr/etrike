# E-Trike CAN Signal Dictionary

**Note:** This file is automatically generated from the YAML definitions (`protocol/contracts/can_high.yaml` and `protocol/contracts/can_low.yaml`). Do not edit manually.
