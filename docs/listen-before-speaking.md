...
*See also: [[defense-in-depth-safety]] for following error and dynamic angle clamp, [[SES/SEB-security-protocol]] for rolling counter + checksum, [[achitecture]] §7.6 for the steering boot sequence, §8.6 for the brake boot sequence.*
