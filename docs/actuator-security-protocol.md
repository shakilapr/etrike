...
*See also: [[listen-before-speaking]] for the boot sequence that must complete before security bytes matter, [[achitecture]] §7.6 for SES protocol, §8.6 for SEB protocol, [[can-dictionary]] for bit-level frame layouts.*
