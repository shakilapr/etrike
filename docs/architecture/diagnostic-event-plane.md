...
| `0x0150` | `SYS_SES_STATUS_TIMEOUT` | SYS→SES | — | NOT_IMPLEMENTED | Low CAN monitor: complete absence of SES `0x201` during vehicle motion |
| `0x0151` | `SYS_SES_L3_FAULT` | SYS→SES | — | NOT_IMPLEMENTED | Low CAN monitor: decodes critical steer faults directly from SES `0x202` |
