...
| `checksum_full` | `test/test_checksum_full.cpp` | SES/SEB security protocol checksums over all message types. |
...
| `CONFIG_BYPASS_SES_SYNC` | Skip steering actuator listen-sync |
