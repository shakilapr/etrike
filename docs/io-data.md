...
| `°/s` | Degrees per second | Steering angle speed | SES ramp rate |
...
Role: real-time physics model, steering control (SES via CAN), CAN gateway between high-side and low-side buses, obstacle braking, heartbeat/watchdog monitoring.
...
| `0x201` | SES_STATUS | `SES_INF_Angle_Status` | bool | 0/1 | SES |
| `0x201` | SES_STATUS | `SES_Control_Mode_Status` | u8 enum | — | SES |
| `0x201` | SES_STATUS | `SES_Error_Status` | u8 enum | {0=N, 1=L1, 2=L2, 3=L3} | SES |
| `0x201` | SES_STATUS | `SES_StrAngle` | i16 (0.1°/bit) | [-780, 780] | SES |
| `0x201` | SES_STATUS | `EPS_SteeringWheel_Torq` | u8 (Nm) | — | SES |
| `0x201` | SES_STATUS | `SES_Tgt_StrAngleSpd` | i16 (0.5°/s/bit) | — | SES |
| `0x201` | SES_STATUS | `SES_RollCnt_Enable_Status` | bool | 0/1 | SES |
| `0x201` | SES_STATUS | `SES_CheckSum_Enable_Status` | bool | 0/1 | SES |
| `0x201` | SES_STATUS | `SES_RollCnt_Status` | u8 (low 4 bits) | 0–15 | SES |
| `0x201` | SES_STATUS | `SES_CheckSum_Status` | u8 | XOR over bytes 0–6 | SES |
...
| `0x169` | VCU_SES_REQ | `VCU_SES_Alignment_Enable` | bool | 0/1 | 50 Hz | SES |
| `0x169` | VCU_SES_REQ | `VCU_SES_Control_Enable` | bool | 0/1 | 50 Hz | SES |
| `0x169` | VCU_SES_REQ | `VCU_SES_Control_Mode` | u8 | — | 50 Hz | SES |
| `0x169` | VCU_SES_REQ | `VCU_SES_Tgt_StrAngle` | i16 (0.1°/bit) | [-780, 780] | 50 Hz | SES |
| `0x169` | VCU_SES_REQ | `VCU_SES_Tgt_StrAngleSpd` | u8 (°/s) | — | 50 Hz | SES |
| `0x169` | VCU_SES_REQ | `roll_cnt_enable` | bool | must be 1 | 50 Hz | SES |
| `0x169` | VCU_SES_REQ | `checksum_enable` | bool | must be 1 | 50 Hz | SES |
| `0x169` | VCU_SES_REQ | `VCU_SES_RollCnt` | u8 (low 4 bits) | 0–15 rolling | 50 Hz | SES |
| `0x169` | VCU_SES_REQ | `VCU_SES_CheckSum` | u8 | XOR over bytes 0–6 | 50 Hz | SES |
| `0x169` | VCU_SES_REQ | `VCU_Veh_Spd_Value` | u8 (km/h) | 0–255 | 50 Hz | SES |
...
### 5.1 SES/SEB SES (Steering Actuator)
...
### 5.2 SES/SEB SEB (Brake Actuator)
...
| RT → SES (0x169) | Steering angle commands from RT to steering actuator |
