...
| 12 V SES power | 12 | 3.3 | GXL 300 V | Red | 30 A peak | 1.0 m | 0.16 V |
...
- Low bus: RT, SYS, MTR, SES, SEB, DC-DC = 6
...
DC-DC Output (12 V, 8 AWG red)
  ...
  └── 12-circuit ATO/ATC fuse block
       ...
       ├── [ATO 30 A] ── SES (12 AWG, H5)        + PTC RUEF300-2
...
| Fuse block → SES | 12 V | 30 A | 12 AWG | 2.0 m | 10.6 mΩ | 0.32 V | 2.65% |
...
6. **SES ECU housing** requires chassis ground per manufacturer spec — bond to same chassis bolt.
...
|--------|-----|-------------|--------------|
| SES | Littelfuse RUEF300-2 | 3 A | 6 A |
...
Left Frame Rail:                    Right Frame Rail:
  ...
  12 V low-current (18 AWG red)       12 V high-current (SES/SEB)
```
...
| Item | Qty | Part Number | Notes |
|------|-----|-------------|-------|
| Wire, 12 AWG red | 1.5 m | GXL-12-RED | SES 12 V power |
| Wire, 12 AWG black | 1.5 m | GXL-12-BLK | SES ground return |
...
| RUEF300-2 PTC | 1 | Littelfuse | SES overcurrent protection |
| PESD5V0S2UT TVS | 1 | Nexperia | Front encoder protection |
| NUP2105L + ACT45B-510-2P | 1 set | CAN protection | SES CAN node |
