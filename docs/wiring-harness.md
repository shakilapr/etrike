...
7. **SES ECU housing** requires a chassis ground per the SES/SEB manufacturer spec — this is for RF shielding, not power return. Bond the housing to chassis with a dedicated strap at its mounting point.
