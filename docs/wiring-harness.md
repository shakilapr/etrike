...
| Fuse block → SES | 12 | Red | 30 A peak | 1.0 m | 0.16 V |
...
REAR ───────────────────────────────────────────────────── FRONT
  ...
  │  │                 ↓                                    │
  │  │   ├── SES steering (12 AWG, front, 1.0 m)          │
...
| Fuse block → SES | 12 V | 30 A | 12 AWG | 1.0 m | 0.16 V | 1.33% |
...
Left Frame Rail:                    Right Frame Rail:
  ...
  12 V distribution (8 AWG red)       12 V high-current (SES/SEB, 12 AWG red)
```
...
| Wire, 12 AWG red (GXL) | 1 m | Forward fuse block → SES |
| Wire, 12 AWG red (GXL) | 0.7 m | Rear fuse block → SEB |
| Wire, 12 AWG black (GXL) | 0.5 m | SES (−) → chassis strap; SEB (−) → chassis strap |
...
| ATO/ATC fuse block, 6-circuit | 2 | One at rear (SEB, MTR, always-on), one at center (SES, Jetson, RT, SYS, lights) |
