...
**Low bus total: ~86% of 500 kbit/s** (primarily from 100 Hz SES/SEB telemetry frames). 0x6FA and 0x6FB alone contribute ~24%. These are lowest-priority diagnostic frames — under bus saturation they would be the first to drop.
...
**Total system: ~5W** (excluding Jetson Orin, SES/SEB actuators, motor controller).
