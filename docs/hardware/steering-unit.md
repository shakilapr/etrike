...
STEER_FAULT:
  ...
  - SES will timeout-fault (lock or limp — verify behavior with steer-by-wire spec)
```
...
| SES timeout-fault behavior | TBD — lock, center, or freewheel | Verify against steer-by-wire spec |
