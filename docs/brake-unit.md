# SES/SEB SEB — Electro-Hydraulic Brake Unit
...
> **Verify against SES/SEB spec** — some units use a different constant or a shift operation.
...
- **Not reconfigurable.** CAN IDs are factory-programmed. `RT_DRIVE_SETPOINT` placed at `0x202` to avoid collision with SES `0x200`.
