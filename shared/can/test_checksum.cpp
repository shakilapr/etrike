// Test: SES/SEB checksum algorithm (XOR ^ 0xFF) and byte 5/6 overlay bits.
//
// Build and run:
...
// (matching the SES/SEB manufacturer CSV specification).
...
int main() {
    printf("=== SES/SEB Checksum Test (XOR ^ 0xFF) ===\n\n");
