...
constexpr uint32_t kIdVcuSesReq         = 0x200;  // RT→SES steering cmd, 50 Hz (SES/SEB factory default)
...
constexpr uint32_t kIdVcuSebReq         = 0x720;  // SYS→SEB brake cmd, 50 Hz (SES/SEB)
...
// 0x200 VCU_SES_REQ — RT→SES (steering command, SES/SEB protocol)
...
// 0x720 VCU_SEB_REQ — SYS→SEB (brake command, SES/SEB protocol)
