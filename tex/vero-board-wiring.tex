...
\hline
\endhead
1 & CAN RX (low bus) & 4 & TWAI RX & SN65HVD230 CRX & \textbf{Active} & Low bus frames from SYS, MTR, SES, SEB \\
\hline
...
\hline
\endhead
1 & ESTOP Button & 1 & Digital, NC, active-low & NC contact from GND to GPIO1 & Internal pull-up. HIGH = ESTOP, including an open wire. \\
\hline
...
\hline
4 & ESTOP Bulb & 18 & Digital out & Relay coil $\rightarrow$ 12\,V & Red — dedicated ESTOP indicator \\
\hline
...
\begin{lstlisting}
GPIO 1  : ESTOP button (NC from GND, internal pull-up, active-low)
...
GPIO 18 : ESTOP bulb (red)
GPIO 19 : |\sout{Right turn signal}| (Unused - USB conflict)
GPIO 20 : (Unused - USB conflict)
