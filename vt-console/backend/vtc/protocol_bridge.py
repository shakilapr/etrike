...
The VTC backend never re-implements CAN codecs. It consumes the YAML-generated
...
(see ``vt-console/workplan.md`` header); this module is the only place the
...
# Repo root is three levels up: vt-console/backend/vtc/protocol_bridge.py
