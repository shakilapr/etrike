...
**Shared hardware:** SES/SEB SEB, 12V PSU, USB-CAN adapter, pressure gauge (if available)
**Output:** `docs/seb-bench-findings.md`

## Objective

Discover the *actual* behavior of the SES/SEB SEB electro-hydraulic brake unit. Every question below affects safety-critical firmware design.
...
Same tests as SES: does SEB require sequential counter? Does it reject bad checksum?
