...
int main(){
    ...
    printf("-- Test 1: Obstacle ESTOP hold angle clamp --\n");
    {
        ...
        int16_t cmd_offset_free = cmd_angle - rt::kSES/SEBAngleOffset;  // strip SES/SEB offset
    ...
    printf("-- Test 3: Non-obstacle ESTOP ramp-to-zero --\n");
    {
        ...
        int16_t first_step_offset_free = first_step - rt::kSES/SEBAngleOffset;  // strip SES/SEB offset
