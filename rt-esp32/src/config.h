...
constexpr int   kSteerCmdRateHz         =   100;    // SES/SEB 10 ms period (was 50Hz — 20ms margin too tight with ±5ms TX jitter)
...
constexpr int   kSES/SEBAngleOffset     = 30000;    // SES/SEB CSV offset: raw = angle_0_1deg + offset (0° → raw=30000)
