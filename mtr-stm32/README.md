...
## 1.1 Command Sources & ECU Pipeline

MTR is the **lowest-level actuator** on the Low CAN bus (500 kbit/s). It is
**source-agnostic**: it accepts a motor/gear command from whichever master is
