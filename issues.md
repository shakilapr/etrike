...
| C3 | ~~P0~~ **DONE** | Pressure mode mapping undefined (Gap #4) | ✅ Verified SES/SEB SEB spec: `VCU_SEB_Pre_Value_Req` is u8 (not u16) at bit 32, scale 0.05 MPa/bit, range 0–5 MPa, raw 0–100. Conversion: `seb_raw = kPa × 0.02`. Both docs updated. Gap #4 struck through. |
