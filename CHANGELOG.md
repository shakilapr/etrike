...
- Bug 7.5: SES 0x201 rolling counter not checked for frozen counter
...
- `CONFIG_BENCH_SOLO`, `BYPASS_SES_SYNC`, `BYPASS_SEB_SYNC`, `BYPASS_MTR_ABSENT` flags for bench testing
...
- Bench bypass flags: `CONFIG_BENCH_SOLO`, `BYPASS_SES_SYNC`, `BYPASS_SEB_SYNC`, `BYPASS_MTR_ABSENT`
- Bench bypass verification: 10 tests across 5 bypass scenarios
...
- SES/SEB checksum algorithm corrected to XOR
...
- SES checksum corrected from SUM to XOR
