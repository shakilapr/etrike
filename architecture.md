...
| 0x169 | TX (low) | 50 Hz current wire schedule; state-machine timing still assumes 100 Hz | Steering angle → SES. Checksum XOR^0xFF. Gated: only in AUTO/ESTOP. Open timing decision described in §15. |
