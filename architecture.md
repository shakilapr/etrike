...
| Bus | IDs | Reason |
|-----|-----|--------|
| Low only | `0x012`, `0x110`, `0x169`, `0x204`, `0x205`, `0x7B9` | DC-DC, mode, steering, drive, brake, and SEB commands. RT-generated or SYS-generated — never leave low bus. |
...
| `0x201` SES_STATUS — steering angle + status | Steering SM: boot sync angle, alignment check, following-error monitor, SES/SEB rolling counter + XOR checksum | `0x169` VCU_SES_REQ → SES (50 Hz, Angle Mode) | Steering angle |
