...
> 
> RT sends `0x203 {i32 brake_pressure_kpa}`. SYS converts: `seb_raw = kpa * kSebPressureScale + kSebPressureOffset`. Placeholder: scale=1.0, offset=0 (raw = kPa). **Verify against SES/SEB SEB spec.**
> 
