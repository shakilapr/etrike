...
|-----|-------|-----------|--------------|-------------|
| RT | esp32-s3-devkitc-1 | espidf | `-D CONFIG_FREERTOS_HZ=1000 -D CONFIG_TWAI_ISR_IN_IRAM=1` | + `-D BENCH_BUILD_ACKNOWLEDGED -D CONFIG_BENCH_SOLO -D CONFIG_BYPASS_SES_SYNC -D CONFIG_BYPASS_SEB_SYNC -D CONFIG_BYPASS_MTR_ABSENT` |
