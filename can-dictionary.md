...
| **Endianness** | Motorola LSB (little-endian) |
| **Note** | Factory default `0x200`. SES/SEB unit is preprogrammed and not reconfigurable. `RT_DRIVE_SETPOINT` placed at `0x202` to avoid collision. |
...
| Not forwarded | `0x201`, `0x721` | SES/SEB feedback, low only |
