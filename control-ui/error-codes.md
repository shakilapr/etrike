...
These codes describe the Control UI and its test infrastructure. RT, SYS, MTR, PWT, SES, and SEB diagnostic flags remain ECU-reported data and are not remapped into fake Control UI failures.
