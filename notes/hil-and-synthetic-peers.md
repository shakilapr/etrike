...
- **Synthetic SES (Steering):** Injects `0x201 SES_STATUS` at 100 Hz, reporting that the steering is centered and healthy. This satisfies the RT ECU's steering sync requirements.
