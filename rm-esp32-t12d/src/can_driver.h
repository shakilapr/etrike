#pragma once
// RM-ESP32-T12D handle-based TWAI CAN driver interface & health monitoring.
// Ported from sys-esp32 / rm-esp32 for wire-level compatibility and DLC 0 preservation.
